...
element					:   token_integer token_float true false id ! token_string array [ ( nil | id
/* Hay un error aqui: se repite id en la prediccion de element */
element1				:   token_integer token_float | true false | id | ! | id | token_integer token_float true false id ! token_string array [ ( nil
element2				:   token_integer token_float true false id ! token_string array [ ( nil | token_string | [ | token_string [ ( | nil
routine					:   if while for funcion log leer importar desde | while | for | funcion | log | leer | importar desde
genoperation		:   token_string [ ( | (
/* Hay un error aqui: se repite todo en la prediccion de genoperation1 */
genoperation1		:   token_integer token_float true false id ! token_string array [ ( nil |   token_integer token_float true false id ! token_string array [ ( nil
fulloperator		:   == | != |&& | ||
genoperator			:   + | - | * | / | ^ | < | > | >= | <=
...
forparam				:   token_string [ | token_string [ ( | id | id
_while					:   while
_if							:   if
_else						:   else \n { | \n end } retorno $
...
boolean					:   true | false
enter						:   \n
n								:   \n | token_integer token_float true false id ! token_string array [ ( nil if else while for funcion retorno log leer importar desde \n end { } retorno $
