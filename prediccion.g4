...
genoperator			:   +
                ...
                |   <=
;
fulloperation		:   token_integer token_float true false id ! token_string array [ ( nil
                |   (
;
fulloperation1	:   token_integer token_float true false id ! token_string array [ ( nil
;
fulloperator		:   ==
                |   !=
                |   &&
