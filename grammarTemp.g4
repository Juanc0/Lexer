1	program : stats	'token_salto_linea', 'id', 'importar', 'desde', 'log', 'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'retorno', 'if', 'for', 'while', 'funcion'
2	program : EPSILON	'$'
3	stats : stat stats1	'token_salto_linea', 'id', 'importar', 'desde', 'log', 'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'retorno', 'if', 'for', 'while', 'funcion'
4	stats : EPSILON	'}', 'end', '$'
5	stats1 : 'token_salto_linea' stats	'token_salto_linea'
6	stats1 : EPSILON	'}', 'end', '$'
7	stat : simple_stat	'id', 'importar', 'desde', 'log', 'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'retorno'
...
18	simple_stat : atom	'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'id'
19	assignment : variable '=' expr	'id'
20	if_stat : 'if' '(' expr ')' stat_block C	'if'
21	C : 'else' stat_block	'else'
22	C : EPSILON	'token_salto_linea', '}', 'end', '$'
...
33	K : '.' 'id' K	'.'
34	K : EPSILON	'(', '=', 'token_salto_linea', '}', 'end', '$', '^', '*', '/', '%', '+', '-', '<=', '>=', '<', '>', '==', '!=', '&&', '||', ')', ',', '{', 'CKEY'
...
45	G : expr H	'!', '(', 'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'id'
46	G : EPSILON	')', 'CKEY'
47	H : ',' expr H	','
48	H : EPSILON	')', 'CKEY'
49	variable : 'id' K variable1	'id'
50	variable1 : J	'('
51	variable1 : EPSILON	'=', '^', '*', '/', '%', '+', '-', '<=', '>=', '<', '>', '==', '!=', '&&', '||', ')', ',', '{', 'token_salto_linea', 'CKEY', '}', 'end', '$'
52	J : '(' G ')'	'('
53	J : EPSILON	'=', '^', '*', '/', '%', '+', '-', '<=', '>=', '<', '>', '==', '!=', '&&', '||', ')', ',', '{', 'token_salto_linea', 'CKEY', '}', 'end', '$'
54	parametro : 'id' parametro1	'id'
55	parametro1 : '=' expr	'='
56	parametro1 : EPSILON	',', ')'
57	expr : '!' expr	'!'
58	expr : '(' expr ')'	'('
59	expr : atom op	'token_integer', 'token_float', 'true', 'false', 'token_string', 'nil', 'OKEY', '{', 'id'
60	op : N expr	'^', '*', '/', '%', '+', '-', '<=', '>=', '<', '>', '==', '!=', '&&', '||'
61	op : EPSILON	')', ',', '{', 'token_salto_linea', 'CKEY', '}', 'end', '$'
62	N : '^'	'^'
63	N : '*'	'*'
64	N : '/'	'/'
65	N : '%'	'%'
